			...
			<tr>
				...
				<?php foreach ($products as $item) { ?>
					<td style="text-align: left;">
						...
						<p class="products-details"><a href="<?php echo get_permalink(get_option('ps_page')); ?>?pid=<?php echo $item->id; ?>" title="<?php echo $item->title; ?>"><img src="<?php bloginfo('home'); ?>/wp-content/plugins/GdeSlon_Affiliate_Shop/img/details.gif" alt="Подробнее" /></a></p>
					</td>
					<?php
						$cnt++;
			...
			<tr>
				<td style="vertical-align: top;">
					...
					<p><a href="<?php echo $product->url; ?>" target="_blank">
						<img src="<?php bloginfo('home'); ?>/wp-content/plugins/GdeSlon_Affiliate_Shop/img/buy.jpg" alt="Купить <?php echo $product->title; ?>" />
					</a></p>
				</td>
				<td>&nbsp;</td>
				<td style="vertical-align: top;">
